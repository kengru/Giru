...
mmg = [
    ...
    'niggas be mamaguebos', 'Si Dios supiera que de la descendencia del hombre iba a surgir tal gran mamaguebo, hubiese abortado a Adam en la primera semana.', 
    'Coño deberia aparecer un Hitler que se lamba a to eto mamaguebos', 'Hey tranquilo amigo, mas chilleo menos mamaguebismo', 
    ...
    'Erase una vez en algun pais del mundo un mamaguebo, el mamaguebo mas grande de todos... y ese mamaguebo era usted.', 'Record Guinness en mamañemismo.', 
    'Dicen que uno es lo que come y usted solo come ripio amiga', 'Por favor, mentenga este espacio 100% MAMAGUEBO FREE. Gracias.', 'Ay pobres incredulos mamaguebos.', 
